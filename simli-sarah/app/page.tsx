...
export default function SarahLivePage() {
  ...
  const initSimli = useCallback(async () => {
    ...
    try {
      ...
      // Initialize with ALL required parameters matching SimliClientConfig interface
      ...
      simliClient.on('failed', (reason: string) => {
        console.error('Simli connection failed:', reason);
      ...
      setError(`Failed to initialize avatar: ${err}`);
      setIsConnecting(false);
    }
  }, []);
    ...
    return (
      <div className="h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md">
          <div className="w-24 h-24 mx-auto rounded-full overflow-hidden mb-6 ring-4 ring-blue-500/50 bg-purple-200 flex items-center justify-center">
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-2">
            ...
            <button 
              onClick={handleSend}
              disabled={isLoading}
              className="bg-blue-600 text-white px-4 rounded-lg disabled:opacity-50 hover:bg-blue-700"
            >
              Send
            </button>
          </div>
